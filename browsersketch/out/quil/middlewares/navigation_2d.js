...
return cljs.core.merge.call(null,initial_state,p1__7017_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_7018 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_7019 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_7018);
var pos_7020 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_7018);
quil.core.scale.call(null,zoom_7019);

var tr__6941__auto___7021 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_7019) - cljs.core.first.call(null,pos_7020)),(((quil.core.height.call(null) / (2)) / zoom_7019) - cljs.core.second.call(null,pos_7020))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__6941__auto___7021);
