...
var vec__6531 = axis;
var a_x = cljs.core.nth.call(null,vec__6531,(0),null);
var a_y = cljs.core.nth.call(null,vec__6531,(1),null);
var a_z = cljs.core.nth.call(null,vec__6531,(2),null);
var vec__6532 = v;
var x = cljs.core.nth.call(null,vec__6532,(0),null);
var y = cljs.core.nth.call(null,vec__6532,(1),null);
var z = cljs.core.nth.call(null,vec__6532,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6533,p__6534){
var vec__6537 = p__6533;
var u1 = cljs.core.nth.call(null,vec__6537,(0),null);
var u2 = cljs.core.nth.call(null,vec__6537,(1),null);
var u3 = cljs.core.nth.call(null,vec__6537,(2),null);
var vec__6538 = p__6534;
var v1 = cljs.core.nth.call(null,vec__6538,(0),null);
var v2 = cljs.core.nth.call(null,vec__6538,(1),null);
var v3 = cljs.core.nth.call(null,vec__6538,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__6539_SHARP_){
return (p1__6539_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__6540_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__6541_SHARP_,angle_lr),angle_ud);
...
var map__6548 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6548__$1 = ((((!((map__6548 == null)))?((((map__6548.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6548.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6548):map__6548);
var up = cljs.core.get.call(null,map__6548__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__6548__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__6550 = cljs.core._EQ_;
var expr__6551 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__6550.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__6551))){
return straight;
} else {
if(cljs.core.truth_(pred__6550.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__6551))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__6550.call(null,quil.middlewares.navigation_3d.space,expr__6551))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__6550.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__6551))){
return up;
} else {
if(cljs.core.truth_(pred__6550.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__6551))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__6550.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__6551))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__6548,map__6548__$1,up,straight){
return (function (p1__6542_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__6542_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__6548,map__6548__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__6553_SHARP_);
});})(initial_state))
);
});
/**
...
var map__6559_6564 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6559_6565__$1 = ((((!((map__6559_6564 == null)))?((((map__6559_6564.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6559_6564.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6559_6564):map__6559_6564);
var vec__6560_6566 = cljs.core.get.call(null,map__6559_6565__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_6567 = cljs.core.nth.call(null,vec__6560_6566,(0),null);
var c_y_6568 = cljs.core.nth.call(null,vec__6560_6566,(1),null);
var c_z_6569 = cljs.core.nth.call(null,vec__6560_6566,(2),null);
var vec__6561_6570 = cljs.core.get.call(null,map__6559_6565__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_6571 = cljs.core.nth.call(null,vec__6561_6570,(0),null);
var u_y_6572 = cljs.core.nth.call(null,vec__6561_6570,(1),null);
var u_z_6573 = cljs.core.nth.call(null,vec__6561_6570,(2),null);
var vec__6562_6574 = cljs.core.get.call(null,map__6559_6565__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_6575 = cljs.core.nth.call(null,vec__6562_6574,(0),null);
var p_y_6576 = cljs.core.nth.call(null,vec__6562_6574,(1),null);
var p_z_6577 = cljs.core.nth.call(null,vec__6562_6574,(2),null);
quil.core.camera.call(null,p_x_6575,p_y_6576,p_z_6577,(p_x_6575 + c_x_6567),(p_y_6576 + c_y_6568),(p_z_6577 + c_z_6569),u_x_6571,u_y_6572,u_z_6573);
